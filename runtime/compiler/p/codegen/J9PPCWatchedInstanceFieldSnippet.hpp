...
#include "codegen/Instruction.hpp" //TR:Instruction
...
class J9PPCWatchedInstanceFieldSnippet : public TR::J9WatchedInstanceFieldSnippet
    ...
    J9PPCWatchedInstanceFieldSnippet(TR::CodeGenerator *cg, TR::Node *node, J9Method *m, UDATA loc, UDATA os)
        : TR::J9WatchedInstanceFieldSnippet(cg, node, m, loc, os), _upperInstruction(NULL), _lowerInstruction(NULL), isloaded(false) {}
    ...
    void loadSnippet() {isloaded = true;}
