...
class OMR_EXTENSIBLE TreeEvaluator: public J9::TreeEvaluator
   ...
   static TR::Register *aConcurrentScavengeSequence(TR::Node *node, TR::CodeGenerator *cg);
   static TR::Register *iConcurrentScavengeSequence(TR::Node *node, TR::CodeGenerator *cg);
