...
J9::Options::fePreProcess(void * base)
   ...
   */
   ...
   if (!parsedXlpCodeCacheOptions)
      ...
      if ((lpInfo->isEnabledForCodeCache) && (0 != lpInfo->pageSizeForCodeCache))
         {
         ...
         largePageSize = requestedLargeCodePageFlags;
      ...
      // Large Pages are enabled, but size is not specified.
      else if (lpInfo->isEnabledForCodeCache)
         {
            ...
            if (0 == largePageSize) {
               j9nls_printf(PORTLIB, J9NLS_ERROR, J9NLS_JIT_OPTIONS_SYSTEM_CONFIG_OPTION_NOT_SUPPORTED, "-XX:+UseLargePages, or -XX:+UseLargePagesCodeCache");
            }
         }
      // Large Pages are not enabled. Use System Default Page Size.
      else
         {
