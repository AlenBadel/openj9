...
ifeq ($(j9vm_env_data64),1)
  CFLAGS += -DPPC64 -qstackprotect -qpath=b:/team/abadel/ws_osb/builds/xlc_patch/160478/
  CXXFLAGS += -DPPC64 -qstackprotect -qpath=b:/team/abadel/ws_osb/builds/xlc_patch/160478/
  CPPFLAGS += -DPPC64 -qstackprotect -qpath=b:/team/abadel/ws_osb/builds/xlc_patch/160478/
endif
